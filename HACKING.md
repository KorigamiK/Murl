...
hidden if the `murl_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `murl_DEVELOPER_MODE` to the configure
...
ion available using the `SPELL_COMMAND` cache
variable.
